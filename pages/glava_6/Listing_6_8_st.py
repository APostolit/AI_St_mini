...
# Прогноз на обученном перцептроне
y_pred = ppn.predict(X_test_std)
st.write('Число ошибочно классифицированных образцов: % d' % (y_test != y_pred).sum())
st.write('Верность: %.2f' % accuracy_score(y_test, y_pred))
