...
st.write('Свет красный, есть пешеходы x=[0, 0]')
x = [0, 0]
my_car(model.predict(x))

st.write('Свет зеленый, есть пешеходы x=[1, 0]')
x = [1, 0]
my_car(model.predict(x))

st.write('Свет красный, нет пешеходов x=[0, 1]')
x = [0, 1]
my_car(model.predict(x))

st.write('Свет зеленый, нет пешеходов x=[1, 1]')
x = [1, 1]
my_car(model.predict(x))