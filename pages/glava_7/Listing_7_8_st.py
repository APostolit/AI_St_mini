...
vide_path_out = execution_path + '/video/transport_detected'
...
video_path_detect = execution_path + '/video/transport_detected.mp4'
# Путь записи файла с кодеком H264 для отображения в streamlit
video_path_h256 = execution_path + '/video/detected_h256.mp4'
