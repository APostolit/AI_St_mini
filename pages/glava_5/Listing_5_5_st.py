...
st.text('Параметры людей для теста сети')
st.text('men_1=' + str(men_1) + ', men_2=' + str(men_2))
...
st.write("men_1: %.3f" % p_men_1)
st.write("men_2: %.3f" % p_men_2)

st.write('Итог тестирования сети')
if p_men_1>= 0.5:
    st.write('men_1- женщина')
else:
    st.write('men_1 - мужчина')

if p_men_2 >= 0.5:
    st.write('men_2 - женщина')
else:
    st.write('men_2 - мужчина')

st.write('Параметры сети после обучения')
st.write('w1=', w1, 'w2=', w2, 'b1=', b1)
st.write('w3=', w3, 'w4=', w4, 'b2=', b2)
st.write('w5=', w5,'w6=', w6, 'b3=', b3)
